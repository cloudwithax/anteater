...
Anteater is a local system maintenance tool. It includes high-risk operations such as cleanup, uninstall, optimization, and artifact removal. We treat safety boundaries, deletion logic, and release integrity as security-sensitive areas.

## Reporting a Vulnerability

Please report suspected security issues privately.

- Email: `liam.cartwright007@gmail.com`
- Subject line: `Anteater security report`
...
- Anteater version and install method
- Distro / OS version (e.g. `cat /etc/os-release` on Linux, `uname -a` on OpenBSD)
...
- False negatives where Anteater refuses to clean something
...
## Security-Focused Areas in Anteater
